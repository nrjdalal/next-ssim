import { FlexColumnCenter, ProseWide } from '../../components/Universal'
      ...
      <ProseWide className="px-6 py-12">
        <FlexColumnCenter>
          <img
            ...
            src="https://ssimdwarka.org/wp-content/uploads/2019/12/7.jpeg"
            alt=""
          />
        </FlexColumnCenter>
        <blockquote>
          ...
          that are relevant to contemporary managerial practices. The institute
          strives to sharpen Management skills and produce managers of tomorrow
          who can meet the global demands in the field of management.
          <br />
          <br />
          ...
          students to learn, experience, and experiment, covering all facets of
        ...
        <img
          className="rounded-3xl h-[400px] w-full object-cover object-center"
