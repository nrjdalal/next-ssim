...
const Contact_us = () => {
  ...
  // const [htmlFormState, sethtmlFormState] = useState(initialState);

  // const handleSubmit = (e) => {
  //   e.preventDefault();
  //   axios.post("https://htmlFormsubmit.co/ajax/admin@nrjdalal.com", {...htmlFormState}).then(res=>{
  //     if(res.status === 200){
  //       setActive(false)
  //       sethtmlFormState(initialState)
