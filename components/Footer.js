...
const Footer = () => {
  return (
    <>
      <footer className="text-gray-600 body-font bg-[#096b97]">
        ...
        <div className="bg-gray-900">
          <div className="container mx-auto py-4 px-5 flex justify-between">
            <span className="w-full text-center sm:text-left text-white text-base tracking-wider italic pb-[75px] sm:p-0">
              <p>
                Designed by{' '}
