            ...
            <section className="text-gray-600 body-font">
              <div className="container px-5 py-5 mx-auto">
                <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                  ...
                  <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">Neeraj Dalal</h2>
            ...
            <section className="text-gray-600 body-font">
              <div className="container px-5 py-5 mx-auto">
                <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
                  ...
                  <p className="leading-relaxed text-lg font-bold">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90&apos;s cronut +1 kinfolk.</p>
                  <span className="inline-block h-1 w-10 rounded bg-blue-500 mt-4 mb-6"></span>
                  <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">Abhishek Garg</h2>
