const Admission_form = () => {
  return (
    <>
      <div className="fixed w-[300px] md:w-[500px] z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-50 rounded-3xl text-white border-2 border-gray-500 cursor-pointer">
